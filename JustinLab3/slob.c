...
/* Lab 3 
   Making syscalls requires this header */
...
/*Lab 3
  Our variables (put these where you make your struct) */
...
static void *slob_alloc(size_t size, gfp_t gfp, int align, int node)
{
	...
	/* Lab 3
	/* variable for storing the free space in partially filled pages */
	...
	list_for_each_entry(sp, slob_list, list) {
		...
		/* Lab 3 
		   This is where the actual partially free memory amount is
		   stored into partially_free */
